  ...
  return (
    <div ref={ref}>
      <div className="flex flex-col gap-16 lg:gap-20">
        <motion.div 
          className="overflow-hidden flex flex-col lg:flex-row gap-12"
          initial="hidden"
        ...
        >
          ...
          <motion.div 
            className="lg:w-1/2 flex flex-col justify-center text-left px-9 lg:px-16 gap-6"
            variants={fadeInUpVariants}
        ...
        >
          <motion.div 
            className="flex lg:w-1/2 px-4 lg:px-0 justify-center items-center w-full order-last"
            variants={fadeInUpVariants}
            transition={{ duration: 0.5 }}
          >
            <Image
          ...
          <motion.div 
            className="lg:w-1/2 flex flex-col justify-center text-left px-9 gap-6"
            variants={fadeInUpVariants}
            transition={{ duration: 0.5, delay: 0.2 }}
          >
