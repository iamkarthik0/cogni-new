...
const MediaHero = () => {
  return (
    <div>
      {/* --------------------------Hero Section------------------- */}
      <div className="pt-16 lg:pt-24  space-y-7">
        <h1 className="h1 lg:max-w-6xl mx-auto text-center">
      ...
      <div className=" pt-6 lg:pt-10">
        <div className=" p-10 lg:p-20 space-y-5 bg-[#EEEEEE]  rounded-[23px] ">
          ...
          <p>
            ...
            and entertainment industry. Our mission is to empower organizations
            with cutting-edge AI technologies that revolutionize content
            creation, audience engagement, and operational efficiency.
          </p>
